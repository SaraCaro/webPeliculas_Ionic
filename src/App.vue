  ...
  <ion-app>
    <ion-split-pane content-id="main-content">
      <ion-menu content-id="main-content" type="overlay">
        <ion-content>
          <ion-list id="inbox-list" class="prueba">
            <ion-list-header>Web De Peliculas</ion-list-header>
...
.prueba {
  box-shadow: 2px 3px 8px 0 rgb(44, 43, 43);
  border-radius: 10px;
}

ion-menu ion-content {
  --background: var(--ion-item-background, var(--ion-background-color, rgb(102, 177, 164)));
}
